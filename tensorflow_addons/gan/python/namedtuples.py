...
class GANModel(collections.namedtuple('GANModel', ('generator_inputs', 'generated_data', 'generator_variables', 'generator_scope', 'generator_fn', 'real_data', 'discriminator_real_outputs', 'discriminator_gen_outputs', 'discriminator_variables', 'discriminator_scope', 'discriminator_fn'))):
...
class InfoGANModel(collections.namedtuple('InfoGANModel', GANModel._fields + ('structured_generator_inputs', 'predicted_distributions', 'discriminator_and_aux_fn'))):
...
class ACGANModel(collections.namedtuple('ACGANModel', GANModel._fields + ('one_hot_labels', 'discriminator_real_classification_logits', 'discriminator_gen_classification_logits',))):
...
class CycleGANModel(collections.namedtuple('CycleGANModel', ('model_x2y', 'model_y2x', 'reconstructed_x', 'reconstructed_y'))):
...
class GANTrainOps(collections.namedtuple('GANTrainOps', ('generator_train_op', 'discriminator_train_op', 'global_step_inc_op', 'train_hooks'))):
    ...
    def __new__(cls, generator_train_op, discriminator_train_op, global_step_inc_op, train_hooks=()):
      return super(GANTrainOps, cls).__new__(cls, generator_train_op, discriminator_train_op, global_step_inc_op, train_hooks)


class GANTrainSteps(collections.namedtuple('GANTrainSteps', ('generator_train_steps', 'discriminator_train_steps'))):
